        ...
        <div className="flex container justify-start items-start flex-col">
          <div className="flex w-full flex-col md:flex-row justify-start items-safe gap-4 mt-10">
            <div className="flex gap-4">
              ...
              />
              <button className="border-2 md:p-3 whitespace-nowrap py-3 px-2 rounded-lg text-sm text-gray-300 hover:bg-[#ef4343] active:bg-[#ef4343] hover:text-white">
                اضافه کردن
              </button>
            </div>
          ...
          <div className="mt-16 w-full">
            <ul>
              <li className="flex justify-between items-center gap-16 w-full">
                <div className="flex gap-1">
                  <input type="checkbox" className="bg-inherit" />
                  <span className="text-gray-300 text-xs md:text-sm">
                    
                    تکمیل تکالیف دانشگاه پردازش تصویر
                  </span>
                </div>
